...
// import { useCreateProduct, useGetProductById, useUpdateProduct } from "@/lib/hooks/api";
...
//       form.setValue("price", product?.product?.price?.toString());
//       form.setValue("quantity", product?.product?.quantity?.toString());
//       form.setValue("material", product?.product?.material);
//       form.setValue("featured", product?.product?.featured);
//       form.setValue("colors", product?.product?.colors);
//       form.setValue("sizes", product?.product?.sizes);

//       // form.setValue("images", product?.product?.images);
//     }
//   }, [product]);
